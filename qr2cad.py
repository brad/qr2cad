...
def get_args():
	...
	parser.add_argument('-d', dest='maxdim', type=int, default=74, help='The maximum size in mm to make the x or y dimension. Only applies if exporting to .scad and/or .stl.')
